				...
				<div class="col p-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><a
								href="${pageContext.request.contextPath }/App/RecentUploads">Recent Uploads</a></li>
						</ol>
					</nav>
				</div>
			</div>
			<div class="row">
				...
				<div class="container shadow rounded my-3">
					<div class="row p-2  shadow-sm bg-light text-dark border">
						<h5>
							<i class="fas fa-images text-primary"></i> Recent Uploads <span
										...
										<ul class="pagination justify-content-center">
											...
											<c:if test="${paginationContext.currentPage gt 1}">
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/App/RecentUploads?page=${paginationContext.currentPage - 1}">Previous</a></li>
											</c:if>
												...
												<c:choose>
													<c:when test="${current eq paginationContext.currentPage}">
														<li class="page-item active"><a class="page-link"
															href="${pageContext.request.contextPath}/App/RecentUploads?page=${current}">${current}</a></li>
													</c:when>
													<c:otherwise>
														<li class="page-item"><a class="page-link"
															href="${pageContext.request.contextPath}/App/RecentUploads?page=${current}">${current}</a></li>
											...
											<c:if
												...
												<li class="page-item"><a class="page-link"
													href="${pageContext.request.contextPath}/App/RecentUploads?page=${paginationContext.currentPage + 1}">Next</a></li>
											</c:if>
										</ul>
									</nav>
								</div>
